...
class LinearModel(nn.Module):
    ...
    def forward(self, x):  # 必须要有forward函数
        y_pred = self.linear_1(x)  # 生成预测y_pred值
...
print("w1 = ", model.linear_1.weight.detach().numpy())
print("b1 = ", model.linear_1.bias.detach().numpy())

print("w2 = ", model.linear_1.weight.detach().numpy())
print("b2 = ", model.linear_1.bias.detach().numpy())
